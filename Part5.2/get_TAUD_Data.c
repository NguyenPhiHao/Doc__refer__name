 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed Aug 31 14:16:51 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME get_TAUD_Data
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  1 */
#define IN_PORT_1_NAME        start_stop
...
extern void get_TAUD_Data_Outputs_wrapper(const real_T *duty,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const boolean_T *start_stop = (boolean_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *pulse = (real_T *) ssGetInputPortRealSignal(S, 2);
    boolean_T *y0 = (boolean_T *) ssGetOutputPortRealSignal(S, 0);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const int_T   p_width2  = mxGetNumberOfElements(PARAM_DEF2(S));
    const real_T *unit = (const real_T *) mxGetData(PARAM_DEF0(S));
    const real_T *TAUDid = (const real_T *) mxGetData(PARAM_DEF1(S));
    const real_T *mode = (const real_T *) mxGetData(PARAM_DEF2(S));
