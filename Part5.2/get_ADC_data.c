 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Jan 10 09:17:40 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME get_ADC_data
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Parameter 1 */
#define PARAMETER_1_NAME      max_vcr_channel
#define PARAMETER_1_DTYPE     real_T
#define PARAMETER_1_COMPLEX   COMPLEX_NO
/* Parameter 2 */
#define PARAMETER_2_NAME      portID
...
extern void get_ADC_data_Outputs_wrapper(const real_T *u0,
			real_T *y0,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *max_vcr_channel = (const real_T *) mxGetData(PARAM_DEF1(S));
    const real_T *portID = (const real_T *) mxGetData(PARAM_DEF2(S));
    
    get_ADC_data_Outputs_wrapper(u0, y0, unit, p_width0, max_vcr_channel, p_width1, portID, p_width2);
}
