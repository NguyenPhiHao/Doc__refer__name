 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Oct 19 10:53:11 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME get_Port_Data
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void get_Port_Data_Outputs_wrapper(const boolean_T *u0,
			boolean_T *y0,
...
{
    const boolean_T *u0 = (boolean_T *) ssGetInputPortRealSignal(S, 0);
    ...
    get_Port_Data_Outputs_wrapper(u0, y0, port, p_width0, pin, p_width1);
}
